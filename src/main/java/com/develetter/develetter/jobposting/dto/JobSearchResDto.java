...
public record JobSearchResDto(
    ...
    public record Position(
            ...
            JobType jobType,         // 근무형태 정보
            JobMidCode jobMidCode,   // 상위 직무 정보
            JobCode jobCode,         // 직무 정보
            ExperienceLevel experienceLevel, // 경력 정보
            RequiredEducationLevel requiredEducationLevel // 학력 정보
    ) {}
