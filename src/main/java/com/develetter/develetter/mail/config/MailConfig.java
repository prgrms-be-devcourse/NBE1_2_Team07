...
public class MailConfig {
    ...
    private static final String MAIL_SMTP_AUTH = "mail.properties.mail.smtp.auth";
    private static final String MAIL_DEBUG = "mail.properties.mail.smtp.debug";
    private static final String MAIL_CONNECTION_TIMEOUT = "mail.properties.mail.smtp.connectiontimeout";
    private static final String MAIL_SMTP_STARTTLS_ENABLE = "mail.properties.mail.smtp.starttls.enable";
